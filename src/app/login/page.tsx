...
export default async function LoginPage() {
  ...
  return (
    <main className="relative grid min-h-screen place-items-center overflow-hidden px-5 py-24">
      ...
      <Link href="/" className="absolute left-5 top-6 z-10 flex items-center gap-3 text-sm font-bold text-stone-400 hover:text-white sm:left-8"><span className="relative size-9 overflow-hidden rounded-xl bg-amber-300"><Image src="/logo.png" alt="" fill sizes="36px" className="object-contain" /></span>Back to the realm</Link>
